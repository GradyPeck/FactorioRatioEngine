...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
  ...
  function srcAppAppRoutingModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _numbercruncher_numbercruncher_component__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
    /*! ./numbercruncher/numbercruncher.component */
    "./src/app/numbercruncher/numbercruncher.component.ts");
    /* harmony import */


    var _csvloader_csvloader_component__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(
    /*! ./csvloader/csvloader.component */
    "./src/app/csvloader/csvloader.component.ts");

    var routes = [{
      path: 'csv',
      component: _csvloader_csvloader_component__WEBPACK_IMPORTED_MODULE_4__["CsvloaderComponent"]
    }, {
      path: 'cruncher',
      component: _numbercruncher_numbercruncher_component__WEBPACK_IMPORTED_MODULE_3__["NumbercruncherComponent"]
    }, {
      path: '',
      component: _csvloader_csvloader_component__WEBPACK_IMPORTED_MODULE_4__["CsvloaderComponent"]
    }];
      ...
      _createClass(CsvloaderComponent, [{
        ...
        value: function parsley(inpoot) {
          ...
          this.csvparser.parse(inpoot, {
            ...
            var _iterator = _createForOfIteratorHelper(_this.csvRecords),
                _step;
        ...
        value: function printRecipes() {
          var _iterator3 = _createForOfIteratorHelper(this.recipeBank.recipes),
              _step3;

          try {
            for (_iterator3.s(); !(_step3 = _iterator3.n()).done;) {//console.log (recipe.name + ": " + recipe.time/this.getCraftSpeed(recipe));
      ...
      _createClass(NumbercruncherComponent, [{
        ...
        value: function firstDomino(searchTerm) {
          ...
          var ary = this.recurseRecipe({
            ...
            data: {},
            time: 1
          }, this.selectAmount); //#region ObjectConsolidation
